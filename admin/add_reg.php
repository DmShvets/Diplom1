...
<div class="data_content">
  	<div class="container h100">
        <form action="admin.php?action=<?php echo $_GET['action']?>&Id=<? echo $_GET['Id']?>" method="post">
            ...
            <label>
                region_name
                <input type="text" name="region_name" value="<?php echo $row['region_name'];?>">
            </label><br>
            <label>
                Key_name
                <input type="text" name="Key_name" value="<?php echo $row['Key_name'];?>">
            </label><br>
            <label>
                Nominative  
                <input type="text" name="Nominative" value="<?php echo $row['Nominative'];?>">
            </label><br>
            <label>
                Ablative
                <input type="text" name="Ablative" value="<?php echo $row['Ablative'];?>">
            </label><br>
            <label>
                Genitive
                <input type="text" name="Genitive" value="<?php echo $row['Genitive'];?>">
            </label><br>
            <label>
                Paragraph1
                <textarea name="Paragraph1"><?php echo $row['Paragraph1'];?></textarea>
            </label><br>
            <label>
                Paragraph2
                <textarea name="Paragraph2"><?php echo $row['Paragraph2'];?></textarea>
            </label><br>
            <label>
                Paragraph3
                <textarea name="Paragraph3"><?php echo $row['Paragraph3'];?></textarea>
            </label><br>
            <label>
                Paragraph4
                <textarea name="Paragraph4"><?php echo $row['Paragraph4'];?></textarea>
            </label><br>
            <label>
                Map
                <textarea name="Map"><?php echo $row['Map'];?></textarea>
            </label><br>
            <label>
                linkHotel
                <textarea name="linkHotel"><?php echo $row['linkHotel'];?></textarea>
            </label><br>
            <label>
                Hotels
                <textarea name="Hotels"><?php echo $row['Hotels'];?></textarea>
            </label>
            <br>

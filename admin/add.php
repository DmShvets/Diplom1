...
<div class="data_content">
  	<div class="container h100">
        <form action="admin.php?action=<?php echo $_GET['action']?>&id=<? echo $_GET['id']?>" method="post">
            ...
            <label>
                ID області
                <input type="text" name="id_region" value="<?php echo $row['id_region'];?>" autofocus required>
            </label><br>
            <label>
                Назва
                <input type="text" name="_name" value="<?php echo $row['_name'];?>">
            </label><br>
            <label>
                Назва зображення
                <input type="text" name="imgName" value="<?php echo $row['imgName'];?>">
            </label><br>
            <label>
                Адреса
